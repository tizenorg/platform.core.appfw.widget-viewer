...
public: //Signals
  ...
  Dali::WidgetView::WidgetViewManager::WidgetViewManagerSignalType& WidgetViewAddedSignal();
  Dali::WidgetView::WidgetViewManager::WidgetViewManagerSignalType& WidgetViewDeletedSignal();
...
private:
  ...
  // Signals
  Dali::WidgetView::WidgetViewManager::WidgetViewManagerSignalType mWidgetViewAddedSignal;
  Dali::WidgetView::WidgetViewManager::WidgetViewManagerSignalType mWidgetViewDeletedSignal;

  typedef std::map<Pepper::ObjectView, Dali::WidgetView::WidgetView> WidgetViewContainer;

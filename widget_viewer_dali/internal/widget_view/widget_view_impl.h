...
public:
   ...
   */
  static Dali::WidgetView::WidgetView New( const std::string& widgetId, const char* bundleData, int width, int height );
...
protected:
   ...
   * Construct a new WidgetView.
   */
  WidgetView( const std::string& widgetId, const char* bundleData, int width, int height );

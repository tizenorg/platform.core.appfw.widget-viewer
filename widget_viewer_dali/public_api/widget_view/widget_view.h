...
public:
   ...
   */
  static WidgetView New( const std::string& widgetId, const char* bundleData, int width, int height );
  ...
  /**
   * @brief Gets instance id of the widget.
   *
   * @since_tizen 3.0
   * @return instance id on success, otherwise 0.
   */

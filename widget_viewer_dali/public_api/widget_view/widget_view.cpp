...
WidgetView WidgetView::New( const std::string& widgetId, const char* bundleData, int width, int height )
{
  return Internal::WidgetView::New( widgetId, bundleData, width, height );
}

...
WidgetViewManager::WidgetViewManagerSignalType& WidgetViewManager::WidgetViewAddedSignal()
{
  return GetImplementation(*this).WidgetViewAddedSignal();
}

WidgetViewManager::WidgetViewManagerSignalType& WidgetViewManager::WidgetViewDeletedSignal()
{
  return GetImplementation(*this).WidgetViewDeletedSignal();
}

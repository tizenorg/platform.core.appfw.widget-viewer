...
WidgetView WidgetViewManager::AddWidget( const std::string& widgetId, const char* bundleData, int width, int height )
{
  return GetImplementation(*this).AddWidget( widgetId, bundleData, width, height );
}

...
public: //Signals
  ...
  typedef Signal< void ( WidgetViewManager, WidgetView ) > WidgetViewManagerSignalType;

  WidgetViewManagerSignalType& WidgetViewAddedSignal();
  WidgetViewManagerSignalType& WidgetViewDeletedSignal();

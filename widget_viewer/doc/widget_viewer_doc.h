 ...
 * @defgroup WIDGET_VIEWER_MODULE Dynamic Box Viewer
 ...
 * You should keep that ID until your dynamic box is running. The ID will be passed to you via widget_create function.
 ...
 * @endocde
 *
 * If you want add a new dynamic box, you can call "widget_add()" function.
 *
 */

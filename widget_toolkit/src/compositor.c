...
struct compositor_handler {
	char *app_id;
	void (*cb)(const char *, const char *, Evas_Object *, void *);
	void *data;
...
API int _compositor_set_handler(const char *app_id, void (*cb)(const char *app_id, const char *event, Evas_Object *obj, void *data), void *data)
{
	struct compositor_handler *handler;
	if (!app_id || !cb) {
